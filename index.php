<?php get_header();
$post_pageID = get_option('page_for_posts'); ?>
    <main id="blogMain">
        <div class="container-fluid p-0">
            <div class="row g-0">
                <div class="col-12">
                   ...
                   if($categories):?>
                    <section class="tagContainer padding">
                        <div class="tagBoxes" lang="<?php echo is_rtl() ? 'fa' : 'en'; ?>">
                           <?php foreach($categories as $category) { ?>
                            <div class="tagBox pan3 wow flipInX center blog-category" data-id="<?php echo $category->term_id;?>" data-wow-delay="0.25s" data-wow-duration="1s"><a
                                        href="#"><?php echo $category->name;?></a></div>
                            <?php }?>
                        </div>
                    </section>
                    <?php endif;
                    ...
                    if ($Posts->have_posts()):?>
                        <section class="blogContent padding">
